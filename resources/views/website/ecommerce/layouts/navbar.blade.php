<nav>
    <ul>
        ...
        <li>
            <a href="blog.html">blog <i class="fa fa-caret-down"></i></a>
            <ul>
                <li>
                    <a href="#">Blog Layouts 1 <i class="fa fa-angle-right"></i></a>
                    <ul>
                ...
                <li>
                    <a href="#">Blog Layouts 2 <i class="fa fa-angle-right"></i></a>
                    <ul>
                ...
                <li>
                    <a href="#">Blog Layouts 3 <i class="fa fa-angle-right"></i></a>
                    <ul>
                ...
                <li>
                    <a href="#">Blog Layouts 4 <i class="fa fa-angle-right"></i></a>
                    <ul>
        ...
        <li>
            <a href="protfolio.html">Protfolio <i class="fa fa-caret-down"></i></a>
            <ul>
