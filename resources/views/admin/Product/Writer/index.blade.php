...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            @include('admin.includes.brade_cumb',['title'=>'All writer'])
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title">Writer</h5>
                            <a href="{{ route('writer.create') }}" class="btn btn-warning"><i class="fa fa-plus"></i> ADD</a>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <div class="text-right">
                                                        <a type="button" href="{{ route('writer.edit',$item->id) }}" 
